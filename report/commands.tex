...
\newcommand{\mastersthesis}{Master's Thesis}
...
\tikzstyle{database} = [cylinder, aspect=0.2, shape border rotate=90, minimum width=3cm, minimum height=1cm, text centered, draw=black, fill=cyan!30]
